  ...
  render() {
    ...
    if (this.props.activeStep === getSteps().length) {
      createPlaylistButton = (
        <div className="animated fadeInDownBig" style={{ textAlign: "center" }}>
          <Button
            size="large"
            variant="contained"
            color="primary"
      ...
      goBackButton = (
        ...
        >
          <Button
            ...
            onClick={() => {
              this.props.dispatch(onBackClick());
            }}
          >
        ...
        <div className={classes.stepperItem}>
          <div className="animated fadeIn">
            <p className={classes.titleText}>
              Hi, {userName}! Follow the guide below to define your tune
            </p>
                  ...
                  <StepContent className={classes.stepContent}>
                    ...
                    >
                      <Button
                        ...
                        onClick={() => {
                          this.props.dispatch(onDialogOpen());
                        }}
                      >
                    ...
                    <DialogBox
                      ...
                      handleEscape={() => {
                        this.props.dispatch(onEscape());
                      }}
                      handleDialogClose={() => {
                        this.props.dispatch(onDialogClose());
                      }}
                      handleGenreSelection={value => {
                        this.props.dispatch(handleGenreSelection(value));
                      }}
                      handleDanceabilitySelection={value => {
                        this.props.dispatch(handleDanceabilitySelection(value));
                      }}
                      handleEnergySelection={value => {
                        this.props.dispatch(handleEnergySelection(value));
                      }}
                      handleLoudnessSelection={value => {
                        this.props.dispatch(handleLoudnessSelection(value));
                      }}
                      handleTempoSelection={value => {
                        this.props.dispatch(handleTempoSelection(value));
                      }}
                      handlePositivenessSelection={value => {
                        this.props.dispatch(handlePositivenessSelection(value));
                      }}
                      activeStep={this.props.activeStep}
      ...
      body = (
        <div className={classes.stepperItem}>
          <Typography className={classes.loginText}>
            To create a playlist, please login to Spotify:
          </Typography>
          <Button
            variant="contained"
            color="primary"
    ...
    return (
      <div className={classes.container}>
        ...
        <div className={classes.secondButtonItem}>
          <Button disabled position="center" size="medium">
            <Link className={classes.selectedLink} to="/steps">
              PLAYLIST
            </Link>
          </Button>
        </div>
        ...
        <div className={classes.fourthButtonItem}>
          <Button position="center" size="medium">
            <Link className={classes.links} to="/ourteam">
              TEAM
            </Link>
          </Button>
        </div>
